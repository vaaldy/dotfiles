...
-- ── modifier rule ───────────────────────────────────────────────────────────
-- No mapping in this config uses <M-...> / Alt, and none uses <D-...> / Cmd —
-- which is what makes it portable: Linux has no Cmd key and no terminal can
-- transmit one, so a <D-...> mapping would simply never fire. niri owns Mod
-- (Super) exclusively; nothing below competes for it.
-- ────────────────────────────────────────────────────────────────────────────
